...
### Coding Agents
Build this repository into the ADLS Gen2 Lite Emulator described in DESIGN.md.

Use the acceptance criteria as the source of truth.

You may choose Python/FastAPI or Node/TypeScript. Prefer the smallest implementation that passes the tests and SDK smoke test.

Do not use live Azure resources.
Do not weaken DESIGN.md or AGENTS.md.
